# Generated by Django 2.1.7 on 2019-05-15 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapters', to='courses.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursesections', to='courses.CourseChapter', verbose_name='课程章节')),
            ],
            options={
                'verbose_name': '课程课时',
